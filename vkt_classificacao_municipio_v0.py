...
df_vkt = pd.read_csv('datasets/2020/vkt_v3.csv', usecols=['Modelo_iCarros_A', 'Modelo_iCarros_B', 'Tipo', 'Marca_Modelo', 'Ano', 'Quantidade'], low_memory=False)
print(df_vkt)
...
#print(vkt2)
print(df_vkt)
df_vkt.to_csv('datasets/2020/vkt_classificacao_v8.csv')
