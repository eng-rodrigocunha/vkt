...
df_marca_modelo_denatran_a = df_marca_modelo_denatran.groupby(['Modelo_A']).sum().sort_values(by=['Quantidade'], ascending=False)
df_marca_modelo_denatran_b = df_marca_modelo_denatran.groupby(['Modelo_B']).sum().sort_values(by=['Quantidade'], ascending=False)
print(df_marca_modelo_denatran_a)
print(df_marca_modelo_denatran_b)
#print(df_marca_modelo_denatran['Quantidade'])
df_marca_modelo_denatran_a = df_marca_modelo_denatran_a[df_marca_modelo_denatran_a['Quantidade'] > np.percentile(df_marca_modelo_denatran_a['Quantidade'],95)]
df_marca_modelo_denatran_b = df_marca_modelo_denatran_b[df_marca_modelo_denatran_b['Quantidade'] > np.percentile(df_marca_modelo_denatran_b['Quantidade'],95)]
print(df_marca_modelo_denatran_a)
print(df_marca_modelo_denatran_b)
...
df_marca_modelo = pd.read_csv('datasets/marca_modelo_lista2.csv')
df_marca_modelo['Modelo'] = df_marca_modelo['Modelo'].str.upper()
df_marca_modelo[['Modelo_A','Modelo_B', 'Modelo_C']] = df_marca_modelo['Modelo'].str.split(' ', n=2, expand=True)
#print(df_marca_modelo_denatran.index)
#print(df_marca_modelo_denatran.index)
df_marca_modelo_denatran_novo_index_aa = df_marca_modelo_denatran_a.index.map(lambda x: get_close_matches(x, df_marca_modelo['Modelo_A'], n=1))
df_marca_modelo_denatran_novo_index_aa = df_marca_modelo_denatran_novo_index_aa.to_list()
df_marca_modelo_denatran_novo_index_aa = list(itertools.chain.from_iterable(df_marca_modelo_denatran_novo_index_aa))
df_marca_modelo_denatran_novo_index_ba = df_marca_modelo_denatran_b.index.map(lambda x: get_close_matches(x, df_marca_modelo['Modelo_A'], n=1))
df_marca_modelo_denatran_novo_index_ba = df_marca_modelo_denatran_novo_index_ba.to_list()
df_marca_modelo_denatran_novo_index_ba = list(itertools.chain.from_iterable(df_marca_modelo_denatran_novo_index_ba))
'''
df_marca_modelo_denatran_novo_index_ab = df_marca_modelo_denatran_a.index.map(lambda x: get_close_matches(x, df_marca_modelo['Modelo_B'], n=1) if x is not None else '')
df_marca_modelo_denatran_novo_index_ab = df_marca_modelo_denatran_novo_index_ab.to_list()
df_marca_modelo_denatran_novo_index_ab = list(itertools.chain.from_iterable(df_marca_modelo_denatran_novo_index_ab))
df_marca_modelo_denatran_novo_index_bb = df_marca_modelo_denatran_b.index.map(lambda x: get_close_matches(x, df_marca_modelo['Modelo_B'], n=1) if x is not None else '')
df_marca_modelo_denatran_novo_index_bb = df_marca_modelo_denatran_novo_index_bb.to_list()
df_marca_modelo_denatran_novo_index_bb = list(itertools.chain.from_iterable(df_marca_modelo_denatran_novo_index_bb))
'''
df_marca_modelo_denatran_novo_index = df_marca_modelo_denatran_novo_index_ba + df_marca_modelo_denatran_novo_index_aa 
#+ df_marca_modelo_denatran_novo_index_ab + df_marca_modelo_denatran_novo_index_bb
df_marca_modelo_denatran_novo_index = list(dict.fromkeys(df_marca_modelo_denatran_novo_index))
...
#print(df_marca_modelo)
df_marca_modelo.to_csv('datasets/priority_v1B.csv', index=False)
