...
def get_tipo (modelo):
    automovel = ['VITARA', 	'SANTANA', 	'CGI', 	'JIMNY', 	'GLA', 	'RURAL', 	'SX4', 	'C180', 	'A200', 	'SWIFT', 	'C200', 	'GLC', 	'SAMURAI', 	'IBIZA', 	'SLK', 	'MB', 	'C250', 	'CLA180', 	'CLA200']
    motocicleta = ['HARLEY DAVIDSON', 'CG', 'YBS', 'FAZER', 'CBX', 'BIZ', 'CB', 'XRE', 'YBR', 'NXR', 'SUZUKI', 'POP', 'PCX', 'SPEED', 'NMAX', 'C100', 'DAFRA', '125', 'CICLOMOTOR', 'LEAD', 	'LANDER', 	'AT115', 	'CRYPTON', 	'XR', 	'WEB', 	'SHINERAY', 	'YAMAHA', 	'SAHARA', 	'XLX', 	'NX', 	'XT', 	'MT03', 	'TRAXX', 	'XL', 	'SH', 	'WUYANG']
